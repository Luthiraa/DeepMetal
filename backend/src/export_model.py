    ...
    def train_model(model, train_loader, test_loader, epochs=5, lr=0.001, device='cpu', dataset_name='mnist'):
    ...
    def test_inference(model, test_loader, device='cpu', num_samples=5, dataset_name='mnist'):
