// STM32F446RE Neural Network with UART Output (FIXED VERSION)
...
// FIXED: Proper vector table syntax
...
void setup_uart(void) {
    ...
    *gpioa_afrl |= (7 << 8) | (7 << 12);         // Set AF7
    ...
    // FIXED: Baud rate for 8MHz HSI clock: 8000000 / 115200 = ~69
    *usart2_brr = 69;
...
void main_program(void) {
    ...
    // FIXED: Removed emoji characters for better compatibility
