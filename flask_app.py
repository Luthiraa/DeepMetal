...
def runn(image_array, original_filename):
...
def process_mnist_image():
    ...
    try:
        ...
        result = runn(image_array, original_filename)
        ...
        failsafe_result = runn(image_array, original_filename)
